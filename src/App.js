...
import TerraformEditorScreen from "./components/TerraformEditor/TerraformEditorScreen";
const App = () => {
  ...
  const renderView = () => {
    switch (currentView) {
      case "login":
        return (
          <LoginScreenMockup onLogin={() => setCurrentView("repository")} />
        );
      case "repository":
        return (
          <RepositoryDashboardMockup
            onConnect={() => setCurrentView("modal")}
          />
        );
      case "modal":
        return (
      ...
      case "terraform":
        return (
          <TerraformEditorScreen onBack={() => setCurrentView("projects")} />
        );
      default:
        return (
          <LoginScreenMockup onLogin={() => setCurrentView("repository")} />
