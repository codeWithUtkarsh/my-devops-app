...
const RepositoryDashboardMockup = ({ onConnect }) => {
    return (
        <div className="flex flex-col h-screen w-full bg-gray-950 text-white">
            ...
            <main className="flex-1 flex flex-col items-center justify-center p-6 relative">
                ...
                <div className="max-w-2xl w-full space-y-8 text-center">
                    ...
                    <button
                        className="mx-auto bg-accent-500 hover:bg-accent-600 text-white py-3 px-8 rounded-lg flex items-center gap-2 transition-colors"
                        onClick={onConnect}
                    >
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default RepositoryDashboardMockup;